...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Address/Add.vue": () => import("./assets/Add-f8372e64.mjs"), "./Pages/Address/index.vue": () => import("./assets/index-abc0642e.mjs"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-a136521e.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-4c378b98.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login-43b9e637.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register-67b2c81b.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-12dc44be.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-5c7a26f0.mjs"), "./Pages/Cart.vue": () => import("./assets/Cart-e9a4ec90.mjs"), "./Pages/Category.vue": () => import("./assets/Category-61db1008.mjs"), "./Pages/Checkout.vue": () => import("./assets/Checkout-6145c894.mjs"), "./Pages/CheckoutSuccess.vue": () => import("./assets/CheckoutSuccess-b9159b6e.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-c2ea23d8.mjs"), "./Pages/Product.vue": () => import("./assets/Product-57103a04.mjs"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-9aae88bf.mjs"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-dd620d75.mjs"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-b7dcaab2.mjs"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-ac6e0a11.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome-5959a246.mjs") })),
  setup({ el, app: app2, props, plugin }) {
    return createApp({ render: () => h$1(app2, props) }).use(pinia).use(plugin).use(I, Ziggy).mount(el);
  }
});
